...
protected:
    ...
    AVLNode* insertHelper(AVLNode* node, int student_ID, std::string name, std::string course, float grade, float GPA);
...
public:
    AVLTree();
    bool insert(int student_ID, std::string name, std::string course, float grade);
